...
public class Rail extends Tile{
	...
	private static final Image IMAGE = new Image(Resource.toUrl("/images/rail.png", Rail.class));

	private static final AudioClip TRACK_SOUND = new AudioClip(Resource.toUrl("/audio/rail_change.wav", Rail.class));
